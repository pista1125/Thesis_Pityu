...
diff_button = button.Button("Belső energia változás", (0, 0, 255), (WIDTH/4, 100), 40)
boly_button = button.Button("Diffúzió", (0, 0, 255), ((WIDTH/4)*3, 100), 40)
brow_button = button.Button("Brown mozgás", (0, 0, 255), (WIDTH/4, 300), 40)
pass_button = button.Button("Bolyongás", (0, 0, 255), ((WIDTH/4)*3, 300), 40)
exit_button = button.Button("Kilépés", (0, 0, 255), (WIDTH/2, 500), 40)

#game 2 button, text stb
